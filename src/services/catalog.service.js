...
const seedFromConfig = async (fileCatalog) => {
    ...
    const rows = fileCatalog.map((service, i) => ({
        ...
        labelOdenglish: service.labelOdenglish,
        ...
        appliances: (service.appliances || []).map((a) => ({
            ...
            labelOdenglish: a.labelOdenglish,
            issues: a.issues || [],
        })),
...
const toCatalogEntry = (doc) => ({
    ...
    labelOdenglish: doc.labelOdenglish || doc.label,
    ...
    appliances: (doc.appliances || []).map((a) => ({
        ...
        labelOdenglish: a.labelOdenglish || a.label,
